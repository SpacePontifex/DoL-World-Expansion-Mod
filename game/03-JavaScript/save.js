	...
	switch (type) {
		...
		case "general":
			result = {
				...
				swarmdisable: { boolLetter: false },
				slimedisable: { boolLetter: false },
				voredisable: { boolLetter: false },
				tentacledisable: { boolLetter: false },
				analdisable: { boolLetter: false },
				transformdisable: { boolLetter: false },
				hirsutedisable: { boolLetter: true },
				breastfeedingdisable: { boolLetter: false },
				analpregdisable: { boolLetter: false },
				watersportsdisable: { boolLetter: false },
				spiderdisable: { boolLetter: false },
				bodywritingdisable: { boolLetter: false },
				parasitedisable: { boolLetter: false},
				slugdisable: { boolLetter: false},
				waspdisable: {boolLetter: false},
				...
				silhouettedisable: { boolLetter: false },
